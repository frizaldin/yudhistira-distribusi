    ...
    <div class="card mb-3">
        <div class="card-body">
            <div class="d-flex flex-wrap gap-2 justify-content-between align-items-center mb-3">
                ...
                <a href="{{ route('delivery_promo.create') }}" class="btn btn-primary btn-sm">
                            ...
                            <tr>
                                ...
                                <td class="text-center sticky-end bg-white">
                                    <div class="d-flex gap-1 justify-content-center">
                                        ...
                                        <form action="{{ route('delivery_promo.destroy', ['nota_kirim_promo' => $item->nota_kirim_promo]) }}" method="POST" class="d-inline" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data ini?');">
                                            @csrf
                                            @method('DELETE')
