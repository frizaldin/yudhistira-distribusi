                    ...
                    success: function(response) {
                        ...
                        if (products.length === 0) {
                            ...
                            products.forEach(function(product, index) {
                                ...
                                // Warehouse: jika Total (exp) dari API masih 0, isi otomatis dengan Kurang SP agar Koli/Eceran/Total terhitung dari data
                                if (exp === 0 && sisaSp > 0) {
                                    exp = sisaSp;
                                }
                                ...
                                if (volume > 0) {
                                    ...
                                    pls = Math.floor(exp % volume); // eceran = sisa pembagian
                                } else {
                                    pls = exp;
                                }
...
$('#products-table-body').html(
            ...
            $(document).on('click', '#btn-save', function() {
                ...
                loadAllProducts(currentWarehouseCode, currentSearchBookCode, currentSearchBookName).then(function(
