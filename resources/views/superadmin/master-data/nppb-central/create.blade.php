    ...
    <div class="card mb-3">
        <div class="card-body">
            <div class="d-flex flex-wrap gap-2 justify-content-between align-items-center mb-3">
                <div>
                    <strong>Tambah Rencana Kirim</strong><br />
                    <small class="text-muted">Tambah data rencana pengiriman dari pusat ke cabang</small>
                </div>
                <div>
            ...
            <form action="{{ route('nppb-central.store') }}" method="POST" id="nppbForm">
                @csrf
                <div class="row g-3">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="book_code" id="book_code" class="form-select select2-ajax @error('book_code') is-invalid @enderror" data-url="{{ route('api.products') }}" data-placeholder="Pilih Buku" required>
                            @if(old('book_code'))
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" class="form-control @error('koli') is-invalid @enderror"
                            id="koli" name="koli" value="{{ old('koli', 0) }}" min="0" step="1">
                        @error('koli')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" class="form-control @error('pls') is-invalid @enderror"
                            id="pls" name="pls" value="{{ old('pls', 0) }}" min="0" step="1">
                        @error('pls')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" class="form-control @error('exp') is-invalid @enderror"
                            id="exp" name="exp" value="{{ old('exp', 0) }}" min="0" step="1">
                        @error('exp')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
