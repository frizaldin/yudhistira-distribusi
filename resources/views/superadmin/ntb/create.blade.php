    ...
    <div class="card mb-3">
        <div class="card-body">
            <div class="d-flex flex-wrap gap-2 justify-content-between align-items-center mb-3">
                <div>
                    <strong>Tambah NTB (Nota Terima Barang)</strong><br />
                    <small class="text-muted">Total eksemplar = (koli × isi koli) + eceran per buku.</small>
                </div>
            ...
            <form action="{{ route('ntb.store') }}" method="POST" id="formNtb">
                @csrf
                ...
                <div class="row g-3 mb-4">
                    <div class="col-md-3">
                        ...
                        <select name="receive_type" id="receive_type"
                            ...
                            <option value="0" {{ old('receive_type', '0') == '1' ? '' : 'selected' }}>Non retur</option>
                            <option value="1" {{ old('receive_type') == '1' ? 'selected' : '' }}>Retur</option>
                        </select>
                        @error('receive_type')
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" name="receive_code" id="receive_code"
                            ...
                            value="{{ old('receive_code') }}" required />
                        @error('receive_code')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="branch_code" id="branch_code"
                            ...
                            @if (old('branch_code'))
                                <option value="{{ old('branch_code') }}" selected>{{ old('branch_code') }}</option>
                            @endif
                        </select>
                        @error('branch_code')
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="branch_sender" id="branch_sender"
                            ...
                            @if (old('branch_sender'))
                                <option value="{{ old('branch_sender') }}" selected>{{ old('branch_sender') }}</option>
                            @endif
                        </select>
                        @error('branch_sender')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-sm align-middle mb-0" id="tabelBuku">
                        ...
                        <tbody id="bodyBuku">
                            ...
                            @php
                                $skipStockRow = !empty($oldItem['skip_central_stock_deduction'])
                                    && (string) $oldItem['skip_central_stock_deduction'] === '1';
                            @endphp
                            <tr class="baris-buku">
