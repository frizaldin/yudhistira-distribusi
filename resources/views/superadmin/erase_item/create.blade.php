        ...
        <div class="card-body">
            ...
            <form action="{{ route('erase_item.store') }}" method="POST" id="formEraseItem">
                ...
                <div class="row g-3 mb-4">
                    <div class="col-md-4">
                        <label for="erase_code" class="form-label">Kode Penghapusan / Referensi <span
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="empl_code" id="empl_code"
                            class="form-select select2-static @error('empl_code') is-invalid @enderror">
                            <option value="">-- Pilih Karyawan --</option>
                            @foreach ($employees as $emp)
                                <option value="{{ $emp->empl_code }}"
                                    {{ old('empl_code') == $emp->empl_code ? 'selected' : '' }}>
