    ...
    <div class="card mb-3">
        <div class="card-body">
            <div class="d-flex flex-wrap gap-2 justify-content-between align-items-center mb-3">
                <div>
                    <strong>Tambah Nota Penghapusan</strong><br />
                    <small class="text-muted">Form penambahan data nota penghapusan baru.</small>
                </div>
                <a href="{{ route('erase_item.index') }}" class="btn btn-outline-secondary btn-sm">
                    <i class="bi bi-arrow-left me-1"></i>Kembali
                </a>
            </div>

            <form action="{{ route('erase_item.store') }}" method="POST" id="formEraseItem">
                @csrf

                {{-- ====== HEADER ====== --}}
                <div class="row g-3 mb-4">
                    <div class="col-md-4">
                        <label for="erase_code" class="form-label">Kode Penghapusan / Referensi <span class="text-danger">*</span></label>
                        <input type="text" name="erase_code" id="erase_code"
                            class="form-control @error('erase_code') is-invalid @enderror"
                            value="{{ old('erase_code') }}" required />
                        @error('erase_code')
                    ...
                    <div class="col-md-4">
                        <label for="trans_date" class="form-label">Tanggal Transaksi</label>
                    ...
                    <div class="col-md-4">
                        <label for="edit_date" class="form-label">Tanggal Edit</label>
                        <input type="date" name="edit_date" id="edit_date"
                            class="form-control @error('edit_date') is-invalid @enderror"
                            value="{{ old('edit_date', date('Y-m-d')) }}" />
                        @error('edit_date')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-4">
                        <label for="empl_code" class="form-label">Kode Karyawan</label>
                        <input type="text" name="empl_code" id="empl_code"
                            class="form-control @error('empl_code') is-invalid @enderror"
                            value="{{ old('empl_code') }}" />
                        @error('empl_code')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
