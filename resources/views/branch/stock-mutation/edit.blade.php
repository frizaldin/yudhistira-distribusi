        ...
        <div class="card-body">
            <div class="d-flex flex-wrap gap-2 justify-content-between align-items-center mb-3">
                <div>
                    ...
                    <small class="text-muted">Total eksemplar = (koli × isi koli) + eceran</small>
                </div>
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <select name="book_code" id="book_code"
                            ...
                            @php
                                $bc = old('book_code', $item->book_code);
                                $bt = $item->product->book_title ?? '';
                            @endphp
                            <option value="{{ $bc }}" selected>{{ $bc }}{{ $bt ? ' — ' . $bt : '' }}</option>
                        </select>
                        @error('book_code')
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="number" name="isi_koli" id="isi_koli" min="0" step="1"
                            ...
                            value="{{ old('isi_koli', $item->isi_koli) }}" required />
                        @error('isi_koli')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-2">
                        ...
                        <input type="number" name="eceran" id="eceran" min="0" step="1"
                            ...
                            value="{{ old('eceran', $item->eceran) }}" required />
                        @error('eceran')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
