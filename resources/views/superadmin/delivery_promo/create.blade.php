        ...
        <div class="card-body">
            ...
            <form action="{{ route('delivery_promo.store') }}" method="POST" id="formDeliveryPromo">
                ...
                <div class="row g-3 mb-4">
                    <div class="col-md-3">
                        <label for="nota_kirim_promo" class="form-label">Nota Kirim / Referensi <span class="text-danger">*</span></label>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="approve_by" id="approve_by"
                            class="form-control @error('approve_by') is-invalid @enderror"
                            value="{{ old('approve_by') }}" />
                        @error('approve_by')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
