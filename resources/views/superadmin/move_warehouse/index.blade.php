    ...
    <div class="card mb-3">
        <div class="card-body">
            <div class="d-flex flex-wrap gap-2 justify-content-between align-items-center mb-3">
                ...
                <a href="{{ route('move_warehouse.create') }}" class="btn btn-primary btn-sm">
            ...
            <form class="row g-2 mb-3" method="GET" action="{{ route('move_warehouse.index') }}">
                <div class="col-md-4">
                    <input type="text" class="form-control" name="search" placeholder="Cari move_code..."
                    ...
                    <tbody>
                        @forelse($items as $item)
                            <tr>
                                ...
                                <td>{{ $item->mova_date ? \Carbon\Carbon::parse($item->mova_date)->format('d/m/Y') : '-' }}
                                </td>
                                <td>{{ $item->officer ?? '-' }}</td>
                                ...
                                <td class="text-center sticky-end bg-white">
                                    <div class="d-flex gap-1 justify-content-center">
                                        ...
                                        <form
                                            action="{{ route('move_warehouse.destroy', ['move_code' => $item->move_code]) }}"
